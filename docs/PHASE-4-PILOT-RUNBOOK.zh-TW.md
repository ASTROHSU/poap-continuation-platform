# Phase 4：10–30 人 Pilot 操作與復原手冊

Phase 4 的目標不是增加平台功能，而是證明一場真實協會活動能由單一發行人獨立完成：
...
程式、備份工具與手冊完成不等於 Phase 4 通過。只有真實 10–30 人 Pilot 達到上述門檻、
保存去識別化對帳報告，並完成空白 D1 還原演練，才把 Phase 4 標記為 Done 並進入歷史
快照匯入。
