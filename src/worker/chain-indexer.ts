...
export async function runLiveChainIndexer(
  env: Pick<
    Bindings,
    "LIVE_DB" | "BASE_RPC_URL" | "BASE_MAINNET_RPC_URL" | "BASE_MAINNET_INDEXER_RPC_URL"
  >,
...
function rpcUrlForChain(
  env: Pick<Bindings, "BASE_RPC_URL" | "BASE_MAINNET_RPC_URL" | "BASE_MAINNET_INDEXER_RPC_URL">,
  chainId: number,
): string {
